...
/* harmony import */ var _service_http_interceptors_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./service/http-interceptors/index */ "./src/app/service/http-interceptors/index.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_service_http_interceptors_index__WEBPACK_IMPORTED_MODULE_5__["httpInterceptorProviders"]],
...
var CheckUserService = /** @class */ (function () {
    ...
    CheckUserService.prototype.checkUser = function () {
        ...
        this.getCheckUser().subscribe(function (categorias) {
        }, function (error) {
            obs.error(error);
        }, function () {
            obs.complete();
